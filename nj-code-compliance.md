---
layout: page
title: "NJ Building Code for Tile Showers: Complete 2026 Compliance Guide"
meta_title: "NJ Tile Shower Building Code Compliance 2026 | IRC + TCNA Standards"
meta_description: "Complete NJ building code guide for tile showers. IRC 2018/2021 requirements, TCNA methods, inspection schedules, permit requirements for Atlantic, Ocean, and Cape May counties. Contractor and homeowner reference."
permalink: /nj-code-compliance/
---
...
1. [NJ Residential Code Overview](#nj-code-overview)
2. [IRC 2018/2021 Tile Requirements](#irc-requirements)
3. [TCNA Method Cross-Reference](#tcna-cross-reference)
4. [Waterproofing Requirements (Critical)](#waterproofing)
5. [Inspection Schedule & Checklist](#inspection-schedule)
6. [Permit Requirements by County](#permits)
7. [Common Code Violations & Fixes](#violations)
8. [Inspector Red Flags](#red-flags)
9. [Code Compliance Checklist (Printable)](#checklist)

---

## NJ Residential Code Overview {#nj-code-overview}
...
## IRC 2018/2021 Tile Requirements {#irc-requirements}
...
## TCNA Method Cross-Reference {#tcna-cross-reference}
...
## Waterproofing Requirements (Critical) {#waterproofing}
...
## Inspection Schedule & Checklist {#inspection-schedule}
...
## Permit Requirements by County {#permits}
...
## Common Code Violations & Fixes {#violations}
...
## Code Compliance Checklist (Printable) {#checklist}

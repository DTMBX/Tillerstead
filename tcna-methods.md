---
layout: page
title: "TCNA Installation Methods: What They Mean for Your Project"
meta_title: "TCNA Tile Installation Methods Explained | Atlantic County NJ"
meta_description: "Complete guide to TCNA installation methods (A108 series, A118 waterproofing). Learn what separates proper tile installation from shortcuts. Inspector-approved standards explained by Tyler the Tiler."
permalink: /tcna-methods/
---
...
1. [What is TCNA?](#what-is-tcna)
2. [Waterproofing Standards (ANSI A118.10)](#waterproofing)
3. [Tile Installation Methods (A108 Series)](#installation-methods)
4. [Substrate Requirements (A108.1A)](#substrate)
5. [Grout & Thinset Specs (A118 Series)](#materials)
6. [Movement Joints (EJ171)](#movement-joints)
7. [What Inspectors Actually Check](#inspector-checklist)
8. [Common Code Violations](#violations)

---

## What is TCNA? {#what-is-tcna}
...
1. You can verify they actually followed them
2. You have recourse if they didn't
3. They're accountable to a specific standard

I cite TCNA methods on every estimate. Here's why I use each one.

---

## Waterproofing Standards (ANSI A118.10) {#waterproofing}
...
**Reasons:**
1. **Pre-formed corners** (no cutting, no failure points)
2. **Integrated system** (pan + drain + membrane = one warranty)
3. **Flood-testable** (I test every shower for 24 hours before tile)
4. **Inspector-approved** (NJ inspectors know it, approve it immediately)
5. **Lifetime warranty** (if installed per manufacturer specs)
...
## Tile Installation Methods (A108 Series) {#installation-methods}
...
## Substrate Requirements (A108.1A) {#substrate}
...
**How I verify:**
1. Walk the floor, feel for bounce
2. Marble test (roll marble, see if it stops or accelerates—indicates sag)
...
## Grout & Thinset Specs (A118 Series) {#materials}
...
## Movement Joints (EJ171) {#movement-joints}
...
**Common mistake:**
❌ **Grouting inside corners** (wall-to-wall, wall-to-floor)

**Correct method:**
✅ **Silicone caulk** in all changes of plane
...
## What Inspectors Actually Check {#inspector-checklist}
...
**Rough-In Inspection:**
1. ✅ Substrate type (cement board, Kerdi-Board, etc.)
2. ✅ Proper attachment (screw spacing 8" o.c.)
3. ✅ Vapor barrier behind substrate (6-mil poly)
4. ✅ Waterproofing membrane visible (Kerdi, Hydroban, etc.)
5. ✅ Pre-slope on shower floor (1/4" per foot minimum)

**Waterproofing Inspection:**
1. ✅ ANSI A118.10-compliant membrane
2. ✅ Membrane extends 6" above shower head
3. ✅ All penetrations sealed (valve, drain)
4. ✅ Inside corners pre-formed or properly detailed
5. ✅ Flood test performed (24 hours, 2" depth)

**Final Inspection:**
1. ✅ Tile installed (verify completion)
2. ✅ Movement joints present (silicone at changes of plane)
3. ✅ Proper slope (water flows to drain)
4. ✅ No cracked tiles
5. ✅ Work matches approved permit
...
## Common TCNA Code Violations {#violations}
...
*Technical information verified against TCNA Handbook 2025 and ANSI standards. All methods cited are current NJ IRC 2018/2021-compliant. Tyler the Tiler | Licensed NJ HIC #13VH10808800*
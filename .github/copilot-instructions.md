...
**All AI and contributor behavior is governed by the centralized instruction system in `/.ai/`:**
...
**Inheritance Chain:** SYSTEM.md → STYLE.md + DOMAIN.md + COMPLIANCE.md + OUTPUT_RULES.md → COPILOT.md

**Reference these files for all decisions. If in doubt, cite the relevant rule.**

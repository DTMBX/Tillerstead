  ...
  <img src="${assets.png.medium}" alt="${alt}" ${loadingAttr} decoding="async" 
    ...
    showStartupBanner() {
      ...
      if (typeof window !== 'undefined' && console.log.toString().includes('native')) {
        ...
        // // // // // // // // // // // // // // // console.log(
          `%c© ${new Date() // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED.getFullYear()} Tillerstead LLC | NJ HIC #13VH10808800`,

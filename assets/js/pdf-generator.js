  ...
  function getLogo() {
    ...
    if (typeof window !== 'undefined' && window.TillerLogo) {
      try {
        ...
        // // // // // // // // console.warn('[TillerPDF] Logo system error:', e); // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED
      }
    }
  ...
  class PDFGenerator {
    ...
    addHeader(title = 'Project Estimate') {
      ...
      try {
        ...
        // // // // // // // // console.warn('Could not add logo to PDF:', e); // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED
      }

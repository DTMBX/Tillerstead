...
class PWAFeatures {
  ...
  initInstallPrompt() {
    ...
    window.addEventListener('appinstalled', () => {
      // // // // // // // // console.log('[PWA] App installed successfully'); // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED
      this.deferredPrompt = null;
  ...
  showInstallPrompt() {
    ...
    banner.querySelector('.pwa-install-btn').addEventListener('click', async () => {
      ...
      // // // // // // // // console.log(`[PWA] User ${outcome} the install prompt`); // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED
      this.deferredPrompt = null;
      this.hideInstallPrompt();
    });
  ...
  async requestNotificationPermission() {
    ...
    if (permission === 'granted') {
      // // // // // // // // console.log('[PWA] Notification permission granted'); // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED
  ...
  async subscribeToPush() {
    try {
      ...
      if (existingSubscription) {
        // // // // // // // // console.log('[PWA] Already subscribed to push'); // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED
        return;
      }
      ...
      // // // // // // // // console.log('[PWA] Push subscription created:', subscription); // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED
  ...
  async sendSubscriptionToServer(subscription) {
    ...
    // // // // // // // // console.log('[PWA] Would send subscription to server:', subscription); // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED
  }
  ...
  initBackgroundSync() {
    if (!('serviceWorker' in navigator) || !('SyncManager' in window)) {
      // // // // // // // // console.log('[PWA] Background sync not supported'); // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED
      return;
    }
  ...
  initAppBadge() {
    if (!('setAppBadge' in navigator)) {
      // // // // // // // // console.log('[PWA] App Badge API not supported'); // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED
      return;
    }

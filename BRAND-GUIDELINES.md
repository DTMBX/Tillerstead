...
7. [Intellectual Property Protection](#intellectual-property-protection)
8. [Prohibited Uses](#prohibited-uses)
9. [Brand Permissions](#brand-permissions)
...
- **Proud** - Taking ownership of superior work
...
4. **Print:** Use CMYK values for print materials
5. **Web:** Use HEX or RGB values for digital media
...
4. **Accessibility:** Minimum 16px body text, adequate contrast
5. **Fallbacks:** Specify fallback fonts (system sans-serif)
...
4. **Show Expertise** - Reference standards and best practices
...
**Customer Communication:** Responsive, helpful, solution-oriented  
...
- Reference industry standards (TCNA, ANSI)
...
1. **Logo Usage**
   - Use Tillerstead logo in your business name or branding
   - Create derivative works or modifications
   - Incorporate logo into your products or services
   - Use logo to imply partnership or endorsement

2. **Color Palette**
   - Register similar color combinations as your brand
   - Create confusingly similar visual identities
   - Use exact color values for competitive services

3. **Typography**
   - Copy typography hierarchy for competitive purposes
   - Create look-alike brands using similar type treatments

4. **Content**
   - Reproduce website content or blog posts
   - Use photographs or project images
   - Copy marketing materials or templates
   - Scrape or aggregate Tillerstead content

5. **Brand Name**
   - Register domain names containing "Tillerstead"
   - Use name in meta tags or SEO for competitive advantage
   - Create social media accounts impersonating brand
...
- Criminal prosecution for fraud or impersonation
...
- Customer testimonials (with project)
...
4. Link to tillerstead.com when possible
...
**Email:** marketing@tillerstead.com  
**Phone:** (609) 862-8808
